                            ...
                            <tr class="cart_item">
                                ...
                                <td class="product-thumbnail">
                                    <div class="cart-product__item">
                                        <a href="#">
                                            <img src="{{ url('uploads/products/'.$product->model->image) }}" alt="{{ Str::limit($product->name, 10) }}" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                        </a>
                                        <div class="cart-product-content">
                                            <h5 class="cart-product-title">{{ Str::limit($product->name, 10) }}</h5>
                                        </div>
                                    </div>
                                </td>
